...
public class RegelResponseMessagePayload implements Serializable
{
   ...
   private RegelResponseMessagePayloadData data;
   @JsonAnySetter
   @JsonInclude(Include.NON_NULL)
   private HashMap<String, Object> additionalProperties;

   public RegelResponseMessagePayload()
   {
   }
   ...
   public RegelResponseMessagePayloadData getData()
   {
      return this.data;
   }

   public void setData(RegelResponseMessagePayloadData data)
   {
      this.data = data;
   }
   ...
   public boolean equals(Object o)
   {
      ...
      {
         RegelResponseMessagePayload self = (RegelResponseMessagePayload) o;
